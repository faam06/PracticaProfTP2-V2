...
<body class="hold-transition sidebar-mini layout-fixed">
    <?php include ("cliente_agregar_modal.php");?>
  <div class="wrapper">
  <!-- Navbar -->
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="images/empresa.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Lista Cliente</span>
    </a>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">   
        ...
        <h3 class='text-right'>
				<button onclick="location.href='exportar_excel_cli.php'" class="btn btn-default" data-toggle="modal"> Exportar Listado</button>
			</h3>
        </div>
                  ...
                  $rows = $stmt->fetchAll(PDO::FETCH_OBJ);
                    foreach($rows as $row){
                      ...
                      <tr>
                        ...
                        <td><?php print ($row->dni_cliente); ?></td>
