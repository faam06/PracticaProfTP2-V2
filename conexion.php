<?php
		class Conexion{
			...
			function Conexion(){
				...
				$this->baseDatos  ="tp2"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
			...
			function conectarse(){
				...
				if($enlace){
					echo "Listado";	//si la conexion fue exitosa nos muestra este mensaje como prueba, despues lo puedes poner comentarios de nuevo: //
				}else{
