...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">  
  ...
  <title>Listado Supervisor</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="images/empresa.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Lista Supervisor</span>
    </a>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">   
        ...
        <div class='col-xs-6'>
      <h3 class='text-right'>
				<button onclick="location.href='exportar_excel_sup.php'" class="btn btn-default" data-toggle="modal"> Exportar Listado</button>
			</h3>
        </div>	
        ...
        <div class="card-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                <?php
                  $sql = "SELECT * FROM usuario WHERE tipo_usr = 1";
