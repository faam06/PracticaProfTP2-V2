  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="images/empresa.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Nuevo Auditor</span>
    </a>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="register-box">
          ...
          <div class="card">
            <br>
            <h3 class="login-box-msg">Agregar Auditor</h3>
          <div class="card-body register-card-body">
          <form action="registro_auditor.php" method="post">           
            ...
            <br>
              <!-- /.col -->
              <div class="">
                <button type="submit" class="btn btn-primary btn-block">Crear Auditor</button>
              </div>
              <!-- /.col -->
          </form>
          </div>
