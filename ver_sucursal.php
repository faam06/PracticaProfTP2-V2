  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      <img src="images/empresa.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Lista Sucursal</span>
    </a>
    ...
    <div class="content-wrapper">
      ...
      <h3 class='text-right'>
				<button onclick="location.href='exportar_excel_suc.php'" class="btn btn-default" data-toggle="modal"> Exportar Listado</button>
			</h3>
        </div>
                  ...
                  $rows = $stmt->fetchAll(PDO::FETCH_OBJ);
                    foreach($rows as $row){
                      ...
                      <tr>
                        ...
                        <td> <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#dataDelete" data-id="<?php echo ($row->id_suc)?>"><i class='glyphicon glyphicon-trash'></i></button></td>                        
                      </tr>
                      <?php
                    }
                      ?> 	
